...
file_path = os.path.join(base_path,r'DNA_moving_color.tif')# Org path : E:\DNADLD_2022\T4_2022-06-15_2,3nguL\5mbar\100x_5mbar_out_013.nd2
#Read tif file
...
settings = {
    # Basic settings
    'file_path_save' : os.path.join(base_path,'output_color.mp4'), #path to save the video
